...
- **manuscript-tables/**: LaTeX-formatted summary tables
...
Version-controlled reference files and JSON schemas used for data
validation. Stored in Git alongside code.
...
- **database_schema/**: Database structure documentation
  - `database_info.txt`: Auto-generated schema reference

**Purpose:**
Enforce data quality standards and enable validation during processing.
