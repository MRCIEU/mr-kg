...
def test_list_traits_success(
    mock_get_service, mock_trait_service, sample_trait_list_items
):
...
def test_get_trait_details_success(
    ...
    with patch(
        "app.core.dependencies.get_database_service"
    ) as mock_analytics_dep:
...
@patch("app.core.dependencies.get_database_service")
def test_get_trait_studies_success(
    mock_get_service, mock_trait_service, sample_trait_embedding
):
...
def test_get_trait_studies_trait_not_found(
    mock_get_service, mock_trait_service
):
