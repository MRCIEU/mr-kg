...
async def basic_health_check(
    ...
    return DataResponse(data=health_data, request_id=request_id)
...
async def database_health_check(
    ...
    try:
        ...
        return DataResponse(data=connectivity_data, request_id=request_id)
    except Exception as e:
        ...
        return DataResponse(data=error_data, request_id=request_id)
...
async def connection_pool_status(
    ...
    try:
        ...
        return DataResponse(data=pool_data, request_id=request_id)
    except Exception as e:
        error_data = {
            "error": str(e),
            "initialized": False,
...
async def application_metrics(
    ...
    return DataResponse(data=metrics_data, request_id=request_id)
...
async def readiness_check(
    ...
    return DataResponse(data=readiness_data, request_id=request_id)
...
async def liveness_check(
    ...
    return DataResponse(data=liveness_data, request_id=request_id)
